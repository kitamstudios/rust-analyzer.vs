...
public class EnvironmentExtensionsTests
{
    ...
    public void OverrideWithEnvironmentBlockTests(string envBlock)
    {
        ...
        var windirKey = newEnv.Keys.Should().ContainSingle(key => key.Equals("windir", StringComparison.OrdinalIgnoreCase)).Which;
        newEnv.Should().Contain(new KeyValuePair<string, string>(windirKey, Environment.GetEnvironmentVariable("windir")));
