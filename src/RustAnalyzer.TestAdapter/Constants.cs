...
{
    public const string ReleaseSummary = $"Updated RLS + dependency on VS2022 17.7. Please report any issues you face. Consider giving 5⭐ if you find this extension useful.";
