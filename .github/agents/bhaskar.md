...
0. You review the current open changes. Adhere to YAGNI, DRY, and SOLID principles.
...
9. Verify applicable changes across Visual Studio 2022 17.12+, Visual Studio 2026 18.x, the main
   VSIX, standalone TestAdapter, and publication evidence. Never claim real-host coverage without
   real-host evidence.
