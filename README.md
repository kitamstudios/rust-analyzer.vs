...
> 💡 **Announcement**
>
> This extension is free & always will be. Rust developers must have basic end to end experience for free.
> But also there is soon going to be paid extension that includes all features in this + wsl/embedded/drive development + editor enhancements + templates + and many more.
